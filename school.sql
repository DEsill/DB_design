...
-- -----------------------------------------------------
-- Table `school`.`tags_has_courses`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `school`.`tags_has_courses` (
  `tags_tag_id` TINYINT NOT NULL,
  `courses_course_id` INT NOT NULL,
  PRIMARY KEY (`tags_tag_id`, `courses_course_id`),
  INDEX `fk_tags_has_courses_courses1_idx` (`courses_course_id` ASC) VISIBLE,
  INDEX `fk_tags_has_courses_tags1_idx` (`tags_tag_id` ASC) VISIBLE,
