...
ALTER TABLE `school`.`tags_has_courses` 
DROP FOREIGN KEY `fk_tags_has_courses_courses1`;
...
ALTER TABLE `school`.`tags_has_courses` 
DROP FOREIGN KEY `fk_tags_has_courses_tags1`;

ALTER TABLE `school`.`tags_has_courses` ADD CONSTRAINT `fk_tags_has_courses_tags1`
  FOREIGN KEY (`tags_tag_id`)
  REFERENCES `school`.`tags` (`tag_id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_tags_has_courses_courses1`
